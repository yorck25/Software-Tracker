...
module.exports = function (app) {
    ...
    app.get('/users', [authJwt.verifyToken, authJwt.isAdmin], trackerController.tracker_users);
    ...
    app.get('/users/:id', [authJwt.verifyToken, authJwt.isAdmin], trackerController.tracker_users_edit);
    ...
    app.post('/users/:id', [authJwt.verifyToken, authJwt.isAdmin], trackerController.tracker_users_edit_post);
    ...
    app.delete('/users/:id', [authJwt.verifyToken, authJwt.isAdmin], trackerController.tracker_delete_users);
};